...
//	private static final String SERVICE="ZoyoouService/";
	...
	private static List<User> testLogin(String username, String password) throws Exception{
		HttpClient  httpClient = new DefaultHttpClient();
		String uri = getUri(SERVICE + "userservice/login/"+"?username="+username+"&password="+password);
		System.out.println("URI: " + uri);
	...
	static List<User> displayResponse(HttpResponse response) throws Exception{
	...
	static String formatResponseString(HttpResponse response) throws IllegalStateException, IOException{
